...
function gorevlendirmetemsilciload(calisanjson)
{
...
async function gorevlendirmetemsilcikaydetx5()
{
    ...
    if (!Number.isInteger(yeniGorev) || yeniGorev < 0 || yeniGorev > 2)
    {
        mesajmetin("Geçersiz görev seçimi.");
        return false;
    }
    ...
    return await gorevlendirmetemsilcikaydet(calisanlar);
}
