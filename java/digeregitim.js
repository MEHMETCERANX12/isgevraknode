...
async function digeregitimsertifikayaz()
{
    ...
    const egitimtur = new Map([[0,"Lütfen Seçiniz"],[1,"İş Ekipmanı Eğitimi"],[2,"Yüksekte Çalışma Eğitimi"],[3,"Kimyasal Eğitimi"],[4,"İş Kazası Eğitimi"],[5,"KKD Eğitimi"],[6,"Kaldırma Aksesuarı"],[7,"Acil Durum Eğitimi"],[8,"Gürültülü Ortamda Güvenli Çalışma Eğitimi"]]);
    ...
    if (egitimturint === 7)
    { bosluk = 50, egitimicerik = { "baslik": "ACİL DURUMLAR EĞİTİMİ SERTİFİKASI", "katilim": "ACİL DURUMLAR - EĞİTİM KATILIM TUTANAĞI", "paragraf": "\u200B\t\t\tYukarıda adı soyadı yazılı çalışan, “İşyerlerinde Acil Durumlar Hakkında Yönetmeliği” çerçevesinde aşağıda yer alan konulardaki eğitim programına başarıyla tamamlayarak bu eğitim belgesini almaya hak kazanmıştır.", "maddeler": ["İşyerinde oluşabilecek acil durumlar", "Acil durum sırasında alınacak tedbirler ve hareket planı", "Toplanma yeri ve acil durum krokisi gösterimi", "Acil çıkış kapıları ve yolları", "Acil durum ekipleri ve görevli kişiler"] } };
    if (egitimturint === 8)
